...
void main() {
    float metallic = per_object_data.objects[f_instance].m_metallic_roughness.r;
    float roughness = per_object_data.objects[f_instance].m_metallic_roughness.g;
    ...
    out_material        = vec4( 1.0, metallic, roughness, 1.0 ); //1 for pbr
}
